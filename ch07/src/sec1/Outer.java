...
class Dbl {
    ...
    public void fnc1() { System.out.println("이중 클래스의 메소드1"); }
}
public class Outer {
    private int item1;
    ...
    public void method1() { System.out.println("외부 클래스의 메소드 1"); }
    //2. 생성 메소드를 이용하는 방법
    public Dbl getDbl() { return new Dbl(); }

    public class Inner { // 멤버(내부) 클래스
        private int item3;
        ...
        public void method2() { System.out.println("내부 클래스의 메소드 2"); }
    }
}
